...
async function validateCommunicatorLink(roomId) {
    ...
    const response = await fetch(`https://allworldtrade.com/api/v2/get/communicator-link/${strippedRoomId}`);
...
async function loadRemoteMediaStream(stream, peers, peer_id) {
    ...
    remoteVideoToImgBtn.style.display = "none";
